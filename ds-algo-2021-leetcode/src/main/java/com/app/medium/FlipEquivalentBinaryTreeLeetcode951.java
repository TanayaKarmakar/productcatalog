...
public class FlipEquivalentBinaryTreeLeetcode951 {
  private static boolean flipEquiv(TreeNode root1, TreeNode root2) {
    ...
    if(root1 == null || root2 == null)
      return false;
    boolean option1 = flipEquiv(root1.left, root2.left) || flipEquiv(root1.left, root2.right);
    boolean option2 = flipEquiv(root1.right, root2.right) || flipEquiv(root1.right, root2.left);
