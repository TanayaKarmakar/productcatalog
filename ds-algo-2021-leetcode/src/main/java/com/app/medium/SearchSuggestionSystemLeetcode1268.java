...
//    private static WordDictionary.TrieNode buildTrie(String[] products) {
//        WordDictionary.TrieNode node = new WordDictionary.TrieNode();
//        for(String product: products) {
//            WordDictionary.TrieNode current = node;
//            for(int i = 0; i < product.length(); i++) {
//                int charIndx = product.charAt(i) - 'a';
//                if(current.nodes[charIndx] == null) {
//                    current.nodes[charIndx] = new WordDictionary.TrieNode();
//                }
...
//        WordDictionary.TrieNode trieNode = buildTrie(products);
//        List<List<String>> result = new ArrayList<>();
//
//        for(int i = 1; i <= searchWord.length(); i++) {
//            String current = searchWord.substring(0, i);
//            WordDictionary.TrieNode node = trieNode;
...
//    }
//
//    private static void traverseList(WordDictionary.TrieNode node, String current, List<String> items) {
//        if(items.size() == 3)
//            return;
//        if(node.flag) {
//            items.add(current);
